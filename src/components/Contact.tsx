...
const contactLinks = [
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/minseob-shin',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    ...
    >
      ...
      <div className="relative min-h-[70vh] overflow-hidden">
        ...
        <div className="relative z-10 min-h-[70vh] flex flex-col items-center justify-center px-6 py-16 md:py-20">
          {/* Let's Connect heading */}
          <h2
            className={`text-3xl md:text-4xl lg:text-5xl font-light text-white tracking-wide transition-all duration-700 mb-4 ${
          ...
          {/* Subtitle */}
          <p 
            className={`text-white/85 text-base md:text-lg font-light mb-10 md:mb-12 text-center max-w-md transition-all duration-700 delay-100 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
            style={{
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-10">
            {contactLinks.map((link, index) => (
              <a
                ...
                className={`group flex flex-col items-center gap-3 p-4 md:p-5 rounded-2xl bg-black/25 backdrop-blur-sm border border-white/20 transition-all duration-500 hover:bg-black/35 hover:scale-105 hover:-translate-y-2 hover:shadow-xl ${
                  isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
                style={{ 
              ...
              >
                <div className="p-3 md:p-4 rounded-full bg-white/20 text-white group-hover:bg-white/30 group-hover:scale-110 transition-all duration-300">
                  {link.icon}
                </div>
                <span className="text-sm md:text-base font-medium text-white">{link.name}</span>
              </a>
            ))}
          </div>
        </div>
