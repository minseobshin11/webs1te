...
export default function Footer() {
  ...
  const bgClass = isDarkTheme ? 'bg-[#0a1628]' : 'bg-[#3d2e26]';
  const textClass = isDarkTheme ? 'text-[#e8dfd6]' : 'text-[#fef6f0]';
  const mutedClass = isDarkTheme ? 'text-[#6a8a9c]' : 'text-[#a89080]';
    ...
    >
      ...
      >
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between w-full">
          {/* Name */}
          <span className="text-base sm:text-lg font-light tracking-wide" style={{ fontFamily: 'Georgia, serif' }}>
            Minseob Shin
          </span>
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className={`${mutedClass} ${hoverClass} transition-colors duration-300`}
              aria-label="Email"
            >
